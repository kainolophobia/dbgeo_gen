...
series([
  function(callback) {
    ...
    client.query('SELECT name, geom AS geometry FROM places LIMIT 2', function(error, result) {
      dbgeo_gen.parse(result.rows, {}, function(error, result) {
  ...
  function(callback) {
    ...
    client.query('SELECT name, geom FROM countries LIMIT 2', function(error, result) {
  ...
  function(callback) {
    ...
    client.query('SELECT 1 AS name, null AS geom', function(error, result) {
      dbgeo_gen.parse(result.rows, null, function(error, result) {
